...
- **Ripartizione incentivo in annualità**: 
  - Se incentivo totale ≤ 15.000€: pagato in **unica soluzione** (unica annualità)
  - Se incentivo totale > 15.000€: pagato in **rate annuali** (2 o 5 anni) con importo diviso per ogni anno in base alla somma degli incentivi di ciascun intervento
