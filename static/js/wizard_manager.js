...
import { SOGGETTI_CONFIG, MATRICE_SA_INTERVENTI, INTERVENTI, RULES, CATASTO, SCHEDE_TECNICHE, FORMULE_INCENTIVO } from "./core/normativa.js";
import { loadCatalogo } from "./core/catalogo_loader.js";

const STEP_LABELS = ["Pratica", "Edificio", "Anagrafiche", "Interventi", "Dati Tecnici", "Economico", "Riepilogo"];
...
const TIPO_SOGGETTO_SA = ["Pubblica Amministrazione", "Privato residenziale", "Condominio", "Privato terziario", "Impresa", "ETS non economico", "ETS economico", "Cooperativa edilizia", "IAP"];
const TIPO_SOGGETTO_SR = ["Pubblica Amministrazione", "Privato", "ETS non economico", "ETS economico", "Cooperativa edilizia", "ESCO", "CER", "AUC"];
const TITOLO_DISPONIBILITA = ["Propriet\u00e0", "Usufrutto", "Diritto superficie", "Locazione", "Comodato"];
const CATEGORIE_CATASTALI = Object.keys(CATASTO.categorie).sort();

const TEST_SCENARIOS_LIST = [
    { group: "Privato Residenziale" },
    { file: "data/tests/test_01_pdc_privato.json", label: "PdC Aria/Acqua III.A — sostituzione caldaia esistente" },
    { file: "data/tests/test_09_infissi_schermature.json", label: "Infissi II.B + Schermature II.C — abbinamento obbligatorio" },
    { file: "data/tests/test_11_ibrido_bivalente.json", label: "Sistema Ibrido III.B (bivalente) + Scaldacqua III.E" },
    { file: "data/tests/test_13_privato_isolamento_pdc.json", label: "Isolamento II.A + PdC III.A — perc_multi 55%" },

    { group: "Impresa" },
    { file: "data/tests/test_02_impresa_grande.json", label: "PdC Grande III.A + Fotovoltaico II.H" },
    { file: "data/tests/test_12_impresa_piccola_multi.json", label: "Isolamento II.A + PdC III.A — maggioraz. piccola impresa" },
    { file: "data/tests/test_20_azion10_iiiG_microcogenerazione.json", label: "Microcogenerazione III.G — catalogo GSE" },
    { file: "data/tests/test_19_azion9_iva_impresa.json", label: "III.A + IVA non ammissibile (2.640€ sottratti)" },

    { group: "Terziario" },
    { file: "data/tests/test_03_isolamento_pareti.json", label: "Isolamento Pareti II.A — superficie opaca" },
    { file: "data/tests/test_04_ricarica_auto.json", label: "Colonnine Ricarica II.G — veicoli elettrici" },
    { file: "data/tests/test_07_completo.json", label: "Full Electric — 5 interventi (II.A+II.B+II.F+III.A+III.D)" },
    { file: "data/tests/test_06_pratica_reale.json", label: "Pratica Reale — incentivo calcolato completo" },

    { group: "Pubblica Amministrazione / ETS" },
    { file: "data/tests/test_08_pa_comune.json", label: "PA <15.000ab — Isolamento II.A + PdC III.A" },
    { file: "data/tests/test_14_check_azion1_1.json", label: "PA <15.000ab — III.A PdC 100% (comune sotto soglia)" },
    { file: "data/tests/test_10_ets_biomassa_solare.json", label: "ETS non econ — Biomassa III.C + Solare III.D" },
    { file: "data/tests/test_16_azion5_ets_non_economico.json", label: "ETS non econ — Isolamento II.A 100%" },
    { file: "data/tests/test_17_azion6_ets_unica_rata.json", label: "ETS non econ — Unica rata (importo >15.000€)" },

    { group: "Massimali e Pratiche Complete" },
    { file: "data/tests/test_05_incentivo_massimo.json", label: "Super Pratica — incentivo massimo erogabile" },

    { group: "Blocchi e Validazioni" },
    { file: "data/tests/test_15_azion4_valvole_non_presenti.json", label: "Blocco — II.B senza valvole termostatiche" },
    { file: "data/tests/test_21_azion11_mantenimento_5anni.json", label: "Blocco — obbligo mantenimento 5 anni non accettato" },
    { file: "data/tests/test_23_azion15_nzeb_volumetrico.json", label: "Blocco — II.D ampliamento volumetrico eccede 25%" },
    { file: "data/tests/test_24_azion14_iiid_prestazionale.json", label: "III.D Solare termico — formula prestazionale Ci*Qu*Sl" },
    { file: "data/tests/test_28_iiib_rapporto_pdc_caldaia_blocco.json", label: "Blocco — III.B ibrido rapporto PdC/caldaia ≤50%" },
    { file: "data/tests/test_29_iiid_solar_cooling_blocco.json", label: "Blocco — III.D Solar Cooling DEC<8" },

    { group: "Aggiornamento CT3.0" },
    { file: "data/tests/test_25_iiif_teleriscaldamento_fasce.json", label: "III.F Teleriscaldamento — 3 fasce potenza (80kW)" },
    { file: "data/tests/test_26_iiic_biomassa_prestazionale.json", label: "III.C Caldaia biomassa — formula prestazionale" },
    { file: "data/tests/test_27_iiic_stufa_logaritmica.json", label: "III.C Stufa pellet — formula logaritmica" },
    { file: "data/tests/test_30_iiif_fascia_alta.json", label: "III.F Teleriscaldamento — fascia >150kW" },
    { file: "data/tests/test_31_iiic_caldaia_legna_logaritmica_d.json", label: "III.C Caldaia legna tipo D — log/lineare" },

    { group: "Funzionalità Specifiche" },
    { file: "data/tests/test_18_azion7_made_in_eu_iii.json", label: "Premialità — Made in EU esteso a Titolo III" },
    { file: "data/tests/test_22_azion12_iia_interno_30percento.json", label: "Maggioraz. — II.A Parete Interna +30% cmax" }
];
...
const UaWizardManager = function(viewportId) {
    ...
    let _currentStep = 0;
    let _praticaData = {
        pratica: { id: "", codice: "", data_inserimento: "", data_richiesta: "", data_fine_lavori: "", nome: "", modalita_accesso: "diretto", note: "" },
        proprietario: {}, richiedente: {}, responsabile: {}, delegato: {},
        edificio: { indirizzo: "", categoria_catastale: "", ambito: "", zona_climatica: "", anno_costruzione: null, superficie_utile_mq: null, impianto_esistente: { tipo: "", potenza_kw: 0, combustibile: "", libretto: false, libretto_codice: "" }, ape: {} },
        interventi: [], dati_tecnici: {},
        ...
        inputs.forEach(function(input) {
            ...
            for (var ci = 0; ci < codici.length; ci++) {
                ...
                if (name.indexOf(codePrefix) === 0) {
                    if (typeof dataObject[codici[ci]] !== "object" || dataObject[codici[ci]] === null) {
            ...
            if (!matched) {
                ...
                if (foundKey) {
                    ...
                    if (underscoreIdx > 0 && dataObject[name.substring(0, underscoreIdx)] !== undefined && typeof dataObject[name.substring(0, underscoreIdx)] === "object") {
    ...
    const _calculateOverallPaymentPlan = function(results, soggettoType) {
        ...
        if (soggettoType === "Pubblica Amministrazione" || soggettoType === "ETS non economico") {
            const plan = {
            ...
            plan.installments.push({ n: 1, amount: parseFloat(total.toFixed(2)), label: "Unica soluzione" });
            return plan;
        }
    ...
    const _fieldHtml = function(labelText, inputHtml) {
        var result = "<div class=\"form-row\"><label>" + labelText + "</label>" + inputHtml + "</div>";
        return result;
    };
    ...
    const _txt = function(name, type, val, ph) {
        var safeVal = val || "";
        var safePh = ph || "";
        var result = "<input type=\"" + type + "\" name=\"" + name + "\" value=\"" + safeVal + "\" placeholder=\"" + safePh + "\">";
        return result;
    };
    ...
    const _num = function(name, val, min, max) {
        ...
        var focusClean = " onfocus=\"if(this.value==='0'||this.value==='0.00')this.value=''\"";
        var result = "<input type=\"number\" name=\"" + name + "\" value=\"" + safeVal + "\"" + safeMin + safeMax + phAttr + focusClean + ">";
        return result;
    };

    const _chk = function(name, label, checked) {
        var checkedAttr = checked ? " checked" : "";
        var result = "<label class=\"checkbox-inline\"><input type=\"checkbox\" name=\"" + name + "\"" + checkedAttr + "> " + label + "</label>";
        return result;
    };
    ...
    const _updateStepIndicator = function() {
        ...
        STEP_LABELS.forEach(function(label, index) {
            ...
            span.className = "step-dot" + (index === _currentStep ? " active" : "") + (index < _currentStep ? " done" : "");
    ...
    const _renderCard = function(title, dataKey, tipoOptions, extraHtml) {
        ...
        card.appendChild(_field("Denominazione", _txt(dataKey + "_denominazione", "text", d.denominazione)));
        card.appendChild(_field("Codice Fiscale / P.IVA", _txt(dataKey + "_cf_piva", "text", d.cf_piva)));
        card.appendChild(_field("Partita IVA", _txt(dataKey + "_partita_iva", "text", d.partita_iva)));
        card.appendChild(_field("Indirizzo", _txt(dataKey + "_indirizzo", "text", d.indirizzo)));
        if (tipoOptions) {
            card.appendChild(_field("Tipo soggetto", _sel(dataKey + "_tipo_soggetto", tipoOptions, d.tipo_soggetto)));
        }
        if (extraHtml) {
    ...
    const _renderStep0 = function() {
        ...
        section.appendChild(_field("Codice pratica", _txt("codice", "text", p.codice || "")));
        section.appendChild(_field("Data inserimento", "<input type=\"date\" name=\"data_inserimento\" value=\"" + (p.data_inserimento || "") + "\">"));
        section.appendChild(_field("Nome pratica", _txt("nome", "text", p.nome, "Es. Ristrutturazione Villa Rossi")));
        section.appendChild(_field("Data richiesta", "<input type=\"date\" name=\"data_richiesta\" value=\"" + (p.data_richiesta || "") + "\">"));
        section.appendChild(_field("Data fine lavori", "<input type=\"date\" name=\"data_fine_lavori\" value=\"" + (p.data_fine_lavori || "") + "\">"));
        section.appendChild(_field("Modalit\u00e0 accesso", _sel("modalita_accesso", MODALITA_ACCESSO, p.modalita_accesso)));
        section.appendChild(_field("Note", "<textarea name=\"note\" rows=\"3\">" + (p.note || "") + "</textarea>"));
        return section;
    };
    ...
    const _renderStep1 = function() {
        ...
        section.appendChild(_field("Indirizzo", _txt("indirizzo", "text", e.indirizzo)));
        section.appendChild(_field("Categoria catastale", _sel("categoria_catastale", CATEGORIE_CATASTALI, e.categoria_catastale)));
        section.appendChild(_field("Ambito", _sel("ambito", AMBITO_OPTIONS, e.ambito)));
        section.appendChild(_field("Zona climatica", _sel("zona_climatica", ZONE_CLIMATICHE, e.zona_climatica)));
        var row2 = document.createElement("div");
        row2.className = "form-row-duo";
        row2.innerHTML = "<div class=\"duo-field\"><label>Anno costruzione</label>" + _num("anno_costruzione", e.anno_costruzione, 1800, 2026) + "</div><div class=\"duo-field\"><label>Superficie utile (mq)</label>" + _num("superficie_utile_mq", e.superficie_utile_mq, 1) + "</div>";
        ...
        fieldset.innerHTML = "<legend style=\"padding:0 10px; font-weight:600; color:#68c8b2;\">Impianto Esistente / Generatore Sostituito</legend>";

        const tipiImpianto = ["Caldaia", "Pompa di Calore", "Biomassa", "Sistema Ibrido", "Altro / Nessuno"];
        const combustibili = ["Metano", "GPL", "Gasolio", "Biomassa", "Elettricità", "Altro"];

        fieldset.appendChild(_field("Tipo impianto esistente", _sel("impianto_esistente_tipo", tipiImpianto, impianto.tipo)));
        fieldset.appendChild(_field("Potenza termica (kW)", _num("impianto_esistente_potenza_kw", impianto.potenza_kw, 0)));
        fieldset.appendChild(_field("Combustibile", _sel("impianto_esistente_combustibile", combustibili, impianto.combustibile)));

        const librettoRow = document.createElement("div");
        librettoRow.className = "form-row";
        librettoRow.innerHTML = "<label>Libretto d'impianto</label>" + _chk("impianto_esistente_libretto", "Presente", impianto.libretto);
        fieldset.appendChild(librettoRow);

        fieldset.appendChild(_field("Codice Catasto / Libretto", _txt("impianto_esistente_libretto_codice", "text", impianto.libretto_codice, "Es. IT0123456789")));
        ...
        paFlags.innerHTML = "<legend style=\"padding:0 10px; font-weight:600; color:#68c8b2;\">Opzioni PA (solo per Pubblica Amministrazione)</legend>";

        const paRow1 = document.createElement("div");
        paRow1.className = "form-row";
        paRow1.innerHTML = "<label>Comune con popolazione &lt; 15.000 abitanti</label>" + _chk("comune_sotto_15k", "Sì (100% intensità)", e.comune_sotto_15k);
        paFlags.appendChild(paRow1);

        const paRow2 = document.createElement("div");
        paRow2.className = "form-row";
        paRow2.innerHTML = "<label>Edificio scolastico o ospedaliero</label>" + _chk("scuola_ospedale", "Sì (100% intensità)", e.scuola_ospedale);
    ...
    const _renderStep2 = function() {
        ...
        section.appendChild(_renderCard("Proprietario (T1)", "proprietario", TIPO_SOGGETTO_SA, function(d, k) {
            var html = _fieldHtml("Titolo propriet\u00e0", _sel(k + "_titolo_proprieta", TITOLO_DISPONIBILITA, d.titolo_proprieta));
            return html;
        }));
        ...
        section.appendChild(_renderCard("Richiedente / SA (T2)", "richiedente", TIPO_SOGGETTO_SA, function(d, k) {
            var html = _fieldHtml("Titolo disponibilit\u00e0", _sel(k + "_titolo_disponibilita", TITOLO_DISPONIBILITA, d.titolo_disponibilita)) + _fieldHtml("PEC", _txt(k + "_pec", "email", d.pec)) + _fieldHtml("Email", _txt(k + "_email", "email", d.email)) + _fieldHtml("Telefono", _txt(k + "_telefono", "tel", d.telefono)) + "<fieldset><legend>Condominio</legend>" + _chk(k + "_verbale_assemblea", "Verbale assemblea", d.verbale_assemblea) + _chk(k + "_tabella_millesimale", "Tabella millesimale", d.tabella_millesimale) + "</fieldset>";
            return html;
        }));
        ...
        section.appendChild(_renderCard("Responsabile / SR (T3)", "responsabile", TIPO_SOGGETTO_SR, function(d, k) {
            var html = _fieldHtml("IBAN", _txt(k + "_iban", "text", d.iban)) + _chk(k + "_mandato_incasso", "Mandato irrevocabile incasso", d.mandato_incasso) + _fieldHtml("PEC", _txt(k + "_pec", "email", d.pec)) + _fieldHtml("Email", _txt(k + "_email", "email", d.email)) + _chk(k + "_certificazione_11352", "Cert. UNI CEI 11352 (ESCO)", d.certificazione_11352) + "<div class=\"coincide-flags\">" + _chk(k + "_coincide_con_proprietario", "Coincide con Proprietario", d.coincide_con_proprietario) + _chk(k + "_coincide_con_richiedente", "Coincide con Richiedente", d.coincide_con_richiedente) + "</div>";
            return html;
        }));
        const dd = _praticaData.delegato || {};
        section.insertAdjacentHTML("beforeend", "<details class=\"delegato-section\"><summary>Delegato (opzionale)</summary>" + _fieldHtml("Denominazione", _txt("delegato_denominazione", "text", dd.denominazione)) + _fieldHtml("CF", _txt("delegato_cf", "text", dd.cf)) + _fieldHtml("Qualifica", _txt("delegato_qualifica", "text", dd.qualifica)) + _fieldHtml("Email", _txt("delegato_email", "email", dd.email)) + "</details>");
        ...
        section.addEventListener("click", function(e) {
            ...
            var fromData = {};
            ["denominazione","cf_piva","partita_iva","indirizzo"].forEach(function(field) {
                var inp = section.querySelector("[name=\"" + fromKey + "_" + field + "\"]");
                fromData[field] = inp ? inp.value : "";
            });
            ["denominazione","cf_piva","partita_iva","indirizzo"].forEach(function(field) {
                var inp = section.querySelector("[name=\"" + toKey + "_" + field + "\"]");
    ...
    const _renderStep3 = function() {
        ...
        var gruppi = { "II.": [], "III.": [] };
        Object.keys(INTERVENTI).sort().forEach(function(code) {
            var meta = INTERVENTI[code];
            var prefix = code.startsWith("II.") ? "II." : "III.";
            var titoloAmmesso = prefix === "II." ? titoloIIAmmesso : titoloIIIAmmesso;
            ...
            var html = "<li class=\"" + liClass + "\"><label><input type=\"checkbox\" name=\"intervento\" value=\"" + code + "\"" + checkedAttr + disabledAttr + "><span class=\"int-code\">" + code + "</span><span class=\"int-name\">" + (meta ? meta.nome : code) + "</span></label></li>";
            if (gruppi[prefix]) gruppi[prefix].push(html);
        });
        var gruppiHtml = "<div class=\"card-title\">Titolo II</div><ul class=\"interventi-lista\">" + gruppi["II."].join("") + "</ul><div class=\"card-title\">Titolo III</div><ul class=\"interventi-lista\">" + gruppi["III."].join("") + "</ul>";
        ...
        const updateExclusivity = function() {
            const checkedGenerator = Array.from(section.querySelectorAll("input[name=intervento]:checked"))
                .find(function(cb) { return riscaldamentoPrincipale.includes(cb.value); });
        ...
        section.addEventListener("change", function(e) {
            if (e.target && e.target.name === "intervento" && riscaldamentoPrincipale.includes(e.target.value)) {
                updateExclusivity();
            }
        });
        ...
        validateBtn.title = "Verifica la compatibilità degli interventi selezionati";
        validateBtn.addEventListener("click", function() {
            var checkboxes = section.querySelectorAll("input[name=intervento]:checked");
            var selected = [];
            ...
            var re = _rulesEngine.validateInterventiPerSoggetto(tipoSA, ambito, selected);
            var dv = document.getElementById("interventi-validation");
            if (!dv) return;
            dv.innerHTML = "";
            if (cre.errors.length > 0 || re.errors.length > 0) {
                var errorsHtml = "<div class=\"alert alert-error\"><strong>Errori:</strong><ul>" + cre.errors.concat(re.errors).map(function(e) { return "<li>" + e + "</li>"; }).join("") + "</ul></div>";
                dv.innerHTML = errorsHtml;
            }
            if (cre.warnings.length > 0 || re.warnings.length > 0) {
                var warnsHtml = "<div class=\"alert alert-warning\"><strong>Avvisi:</strong><ul>" + cre.warnings.concat(re.warnings).map(function(w) { return "<li>" + w + "</li>"; }).join("") + "</ul></div>";
                dv.innerHTML += warnsHtml;
            }
            if (cre.success && re.success) {
                var successHtml = "<div class=\"alert alert-success\">Combinazione interventi compatibile.</div>";
    ...
    const _renderStep4 = function() {
        ...
        section.innerHTML = "<div class=\"section-title\">Dati Tecnici per Intervento</div>";
        const selezionati = _praticaData.interventi || [];
        ...
        selezionati.forEach(function(code) {
            ...
            if (!scheda) { section.innerHTML += "<p>" + code + ": nessuna scheda.</p>"; return; }
            const card = document.createElement("article");
            card.className = "tecnica-card";
            card.innerHTML = "<div class=\"card-title\">" + code + " \u2014 " + scheda.nome + "</div>" + (scheda.descrizione ? "<p>" + scheda.descrizione + "</p>" : "");
            ...
            (scheda.campi || []).forEach(function(campo) {
                ...
                if (campo.tipo === "select") {
                    card.appendChild(_field(campo.label, _sel(name, campo.opzioni || [], val), campo.note));
                } else if (campo.tipo === "number") {
                    card.appendChild(_field(campo.label + (campo.unita ? " (" + campo.unita + ")" : ""), _num(name, val, campo.min, campo.max), campo.note));
                } else {
                    card.appendChild(_field(campo.label, _txt(name, "text", val), campo.note));
                }
            });
    ...
    var CATALOGO_CONFIG = {
        "III.A": {
            marcaLabel: "Marca PDC", modelloLabel: "Modello PDC",
            marcaField: "marca_pdc", modelloField: "modello_pdc",
            formatModello: function(r) { return (r.modello || "") + " (" + (r.potenza_termica_kw || "?") + " kW, ηs " + (r.efficienza_stagionale || "?") + ")"; },
            fills: [ { from: "potenza_termica_kw", to: "potenza_pdc_kw" }, { from: "scop_cop", to: "scop" }, { from: "efficienza_stagionale", to: "eta_s" } ],
            clears: ["modello_pdc", "potenza_pdc_kw", "scop", "eta_s"]
        },
        "III.B": {
            marcaLabel: "Marca sistema ibrido", modelloLabel: "Modello sistema",
            marcaField: "marca_ibrido", modelloField: "modello_ibrido",
            formatModello: function(r) { return (r.modello || "") + " (" + (r.potenza_pdc_kw || "?") + " kW, ηs " + (r.efficienza_stagionale || "?") + ")"; },
            fills: [ { from: "potenza_pdc_kw", to: "potenza_pdc_kw" }, { from: "scop_cop", to: "scop" }, { from: "efficienza_stagionale", to: "eta_s" } ],
            clears: ["modello_ibrido", "potenza_pdc_kw", "scop", "eta_s"]
        },
        "III.C": {
            marcaLabel: "Marca generatore", modelloLabel: "Modello generatore",
            marcaField: "marca_biomassa", modelloField: "modello_biomassa",
            formatModello: function(r) { return (r.modello || "") + " (" + (r.potenza_termica_kw || "?") + " kW, " + (r.alimentazione || "?") + ")"; },
            fills: [ { from: "potenza_termica_kw", to: "potenza_nominale_kw" }, { from: "classe_ambientale", to: "classe_emissiva" }, { from: "alimentazione", to: "tipo_biomassa" } ],
            clears: ["modello_biomassa", "potenza_nominale_kw", "classe_emissiva", "tipo_biomassa"]
        },
        "III.D": {
            marcaLabel: "Marca pannello", modelloLabel: "Modello pannello",
            marcaField: "marca_solare", modelloField: "modello_solare",
            formatModello: function(r) { return (r.modello || "") + " (" + (r.area_lorda_m2 || "?") + " m²)"; },
            fills: [ { from: "area_lorda_m2", to: "superficie_lorda_mq" } ],
            clears: ["modello_solare", "superficie_lorda_mq"]
        },
        "III.E": {
            marcaLabel: "Marca scaldacqua", modelloLabel: "Modello scaldacqua",
            marcaField: "marca_scaldacqua", modelloField: "modello_scaldacqua",
            formatModello: function(r) { return (r.modello || "") + " (" + (r.capacita_accumulo_litri || "?") + " L, classe " + (r.classe_energetica || "?") + ")"; },
            fills: [ { from: "capacita_accumulo_litri", to: "capacita_litri" }, { from: "classe_energetica", to: "classe_energetica" } ],
            clears: ["modello_scaldacqua", "capacita_litri", "classe_energetica"]
        },
        "III.G": {
            marcaLabel: "Marca microcogeneratore", modelloLabel: "Modello microcogeneratore",
            marcaField: "marca_cogen", modelloField: "modello_cogen",
            formatModello: function(r) { return (r.modello || "") + " (" + (r.potenza_elettrica_kwe || "?") + " kWe, PES " + (r.pes_pct || "?") + "%)"; },
            fills: [ { from: "potenza_elettrica_kwe", to: "potenza_elettrica" }, { from: "potenza_termica_kwt", to: "potenza_termica" }, { from: "rendimento_elettrico_pct", to: "rendimento_elettrico" }, { from: "rendimento_termico_pct", to: "rendimento_termico" }, { from: "pes_pct", to: "pes" } ],
            clears: ["modello_cogen", "potenza_elettrica", "potenza_termica", "rendimento_elettrico", "rendimento_termico", "pes"]
        }
    };
    ...
    var _injectCatalogo = function(card, code, datiCorrenti, catalogo) {
        ...
        marche.forEach(function(m) {
            marcaOpts += '<option value="' + m.replace(/"/g, "&quot;") + '">' + m + "</option>";
        });

        var catHtml = '<div class="catalogo-pdc">'
            + '<div class="form-row"><label>' + cfg.marcaLabel + '</label><select class="cat-marca" name="' + marcaName + '">' + marcaOpts + '</select></div>'
            + '<div class="form-row"><label>' + cfg.modelloLabel + '</label><select class="cat-modello" name="' + modelloName + '"><option value="">-- Seleziona modello --</option></select></div>'
            + '<hr class="cat-sep">'
            + '</div>';
        ...
        var _aggiornaModelli = function() {
            ...
            filtered.forEach(function(r) {
                opts += '<option value="' + (r.modello || "").replace(/"/g, "&quot;") + '">' + cfg.formatModello(r) + "</option>";
            });
        ...
        var _applicaModello = function() {
            ...
            for (var i = 0; i < catalogo.length; i++) {
                if (catalogo[i].marca === selectedMarca && catalogo[i].modello === selectedMod) {
                    found = catalogo[i];
                    break;
                }
            }
        ...
        if (marca && marche.indexOf(marca) !== -1) {
            ...
            _aggiornaModelli();
            if (modello) {
                var modelloEsiste = catalogo.some(function(r) { return r.marca === marca && r.modello === modello; });
                if (modelloEsiste) {
    ...
    var formatNum = function(val) {
        ...
        if (typeof val === "string") { val = parseFloat(val.replace(",", ".")); if (isNaN(val)) return val; }
    ...
    var MAGGIORAZIONI_LIST = [["piccola_impresa","Piccola impresa (+20%)"],["media_impresa","Media impresa (+10%)"],["zona_assistita_a","Zona ass. Art.107.3.a (+15%)"],["zona_assistita_c","Zona ass. Art.107.3.c (+5%)"]];
    ...
    var _syncEconomicoDaFlatKeys = function() {
        ...
        var flatKeys = Object.keys(eco).filter(function(k) {
            return k.indexOf("eco_spesa_") === 0 || k.indexOf("eco_iva_") === 0 || k.indexOf("magg_") === 0;
        });
        flatKeys.forEach(function(k) { delete eco[k]; });
    };
    ...
    const _renderStep5 = function() {
        ...
        selezionati.forEach(function(code) {
            ...
            section.appendChild(_field((meta ? code + " \u2014 " + meta.nome : code) + " \u2014 Importo (\u20ac)", _num("eco_spesa_" + code, spesa, 0)));
            var iva = ivaValues[code] || 0;
            section.appendChild(_field((meta ? code + " \u2014 " + meta.nome : code) + " \u2014 IVA (\u20ac)", _num("eco_iva_" + code, iva, 0)));
        });
        var attive = _praticaData.economico.maggiorazioni || [];
        var maggiorazioniHtml = "<div class=\"card-title\">Maggiorazioni</div><div class=\"maggiorazioni-list\">";
        MAGGIORAZIONI_LIST.forEach(function(m) {
            var checked = attive.indexOf("magg_" + m[0]) !== -1;
            maggiorazioniHtml += "<div class=\"maggiorazione-row\">" + _chk("magg_" + m[0], m[1], checked) + "</div>";
        });
        ...
        calcBtn.addEventListener("click", function() {
            ...
            selezionati.forEach(function(code) {
                ...
                var contesto = { soggetto: richiedente.tipo_soggetto, zonaClimatica: edificio.zona_climatica, isMultiIntervento: selezionati.length > 1, codiciSelezionati: selezionati, comuneSotto15k: !!edificio.comune_sotto_15k, scuolaOspedale: !!edificio.scuola_ospedale };
                var mapMagg = { "piccola_impresa": "piccolaImpresa", "media_impresa": "mediaImpresa" };
            ...
            Object.keys(results).forEach(function(code) {
                var r = results[code];
                html += "<div class=\"result-card\"><div class=\"card-title\">" + code + "</div>";
                if (r.errors && r.errors.length > 0) {
                    var errorHtml = "<p class=\"error\">" + r.errors.join("<br>") + "</p>";
                    html += errorHtml;
                } else {
                    if (r.warnings && r.warnings.length > 0) {
                        var warnHtml = "<div class=\"alert alert-warning\" style=\"padding:8px;margin:8px 0;background:rgba(255,193,7,0.1);border:1px solid rgba(255,193,7,0.3);border-radius:4px;font-size:0.85rem;\">";
                        warnHtml += r.warnings.map(function(w) { return "<div>" + w + "</div>"; }).join("");
                        warnHtml += "</div>";
                        html += warnHtml;
                    }
                    html += "<p>Incentivo: <strong>" + PreventivoManager.formatCurrency(r.amount || 0) + "</strong></p>";
                    if (r.incentivoNetto !== undefined) {
                        html += "<p>Netto: " + PreventivoManager.formatCurrency(r.incentivoNetto) + "</p>";
                    }
                    if (r.corrispettivoGSE) {
                        html += "<p>GSE: " + PreventivoManager.formatCurrency(r.corrispettivoGSE.importo) + "</p>";
                    }
                    if (r.paymentPlan) {
                        html += "<p>Rate: " + formatNum(r.paymentPlan.numInstallments) + "</p>";
                    }
                    totale += r.amount || 0;
                }
                html += "</div>";
            ...
            if (Object.keys(results).length > 0) {
                var totaleHtml = "<div class=\"result-totale\"><strong>Incentivo totale complessivo: " + PreventivoManager.formatCurrency(totale) + "</strong></div>";
                
                const overallPlan = _calculateOverallPaymentPlan(results, richiedente.tipo_soggetto);
                if (overallPlan) {
                    let planHtml = "<div class=\"payment-plan-overall\" style=\"margin-top:15px;padding:12px;border:1px dashed #68c8b2;border-radius:6px;background:rgba(104,200,178,0.05);\">";
                    planHtml += "<div style=\"font-weight:600;color:#68c8b2;margin-bottom:8px;\">Piano di Erogazione Incentivo Complessivo</div>";
                    if (overallPlan.isSinglePayment) {
                        planHtml += "<p style=\"margin:4px 0;\">Modalità: <strong>Unica annualità (Soluzione unica)</strong></p>";
                        planHtml += "<p style=\"margin:4px 0;\">Importo: <strong>" + PreventivoManager.formatCurrency(overallPlan.total) + "</strong></p>";
                    } else {
                        planHtml += "<p style=\"margin:4px 0;\">Ripartizione in <strong>" + overallPlan.numInstallments + " rate annuali</strong>:</p>";
                        planHtml += "<table style=\"width:100%;font-size:0.9em;margin-top:5px;\">";
                        overallPlan.installments.forEach(function(inst) {
                            planHtml += "<tr><td>" + inst.label + "</td><td style=\"text-align:right;font-weight:600;\">" + PreventivoManager.formatCurrency(inst.amount) + "</td></tr>";
                        });
                        planHtml += "</table>";
                    }
                    planHtml += "</div>";
                ...
                if (richiedente.tipo_soggetto === "Pubblica Amministrazione" || richiedente.tipo_soggetto === "ETS non economico") {
                    if (_praticaData.pratica.modalita_accesso === "prenotazione") {
                        ...
                        for (var keyAcc in results) {
                            if (results.hasOwnProperty(keyAcc)) {
                                ...
                                if (rP.paymentPlan && rP.paymentPlan.numInstallments > maxDurata) {
                        ...
                        var accontoLabel = maxDurata > 2 ? "40% (2/5 per durata 5 anni)" : "50% (per durata 2 anni)";
                        var accontoHtml = '<div class="payment-plan-overall" style="margin-top:15px;padding:12px;border:1px dashed #ff9800;border-radius:6px;background:rgba(255,152,0,0.05);">'
                            + '<div style="font-weight:600;color:#ff9800;margin-bottom:8px;">Acconto PA (Prenotazione)</div>'
                            + '<p style="margin:4px 0;">Acconto massimo erogabile: <strong>' + PreventivoManager.formatCurrency(accontoMax) + '</strong> (' + accontoLabel + ')</p>'
                            ...
                            + '<input type="number" id="eco-importo-acconto" name="importo_acconto" value="' + (_praticaData.economico.importo_acconto || Math.min(accontoMax, totale * (accontoPerc - 0.1))) + '" min="0" max="' + accontoMax + '" step="0.01" style="width:180px;margin-left:10px;padding:6px;background:rgba(255,255,255,0.1);border:1px solid rgba(255,255,255,0.2);border-radius:4px;color:#fff;">'
                            + '</div></div>';
    ...
    const _normalizeFromComposed = function(dati) {
        ...
        dati.interventi.forEach(function(iv) {
            ...
            if (Array.isArray(eco.preventivo)) {
                eco.preventivo.forEach(function(p) { preventivo.push(p); });
            }
            if (eco.maggiorazioni) maggiorazioni = eco.maggiorazioni;
            if (eco.incentivo) incentivo = eco.incentivo;
        });
        dati.dati_tecnici = dt;
        dati.economico = { spese: spese, preventivo: preventivo, maggiorazioni: maggiorazioni, incentivo: incentivo };
    };
    ...
    const _exportPraticaTxt = function(dati) {
        ...
        if (interventi.length > 0 && typeof interventi[0] === "object") {
            interventi = interventi.map(function(iv) {
        ...
        const add = function(t) { lines.push(t); };
        ...
        const impiantoPot = impianto.potenza_kw ? impianto.potenza_kw + " kW" : "N/D";
        ...
        if (interventi.length) {
            ...
            interventi.forEach(function(code) {
                ...
                for (const k in campi) {
                    if (campi.hasOwnProperty(k) && campi[k] !== "" && campi[k] !== null && campi[k] !== undefined) {
                        add("    " + k + ": " + campi[k]);
                    }
                }
            });
        ...
        if (eco.preventivo && eco.preventivo.length) {
            const sortedPreventivo = eco.preventivo.slice().sort(function(a, b) {
                return (a.codice_intervento || "").localeCompare(b.codice_intervento || "");
            });
            add("PREVENTIVO");
            add(SEPARATOR);
            let tot = 0;
    ...
    const _printSintesi = function() {
        ...
        const docHtml = '<!DOCTYPE html><html><head><title>Sintesi Pratica CT 3.0</title>'
            + '<style>'
    ...
    const _archivePratica = async function() {
        ...
        if (interventi.length > 0) {
            ...
            const accettato = chkObbligo ? chkObbligo.checked : _praticaData.obbligo_mantenimento_accettato === true;
            if (!accettato) {
                alert("Obbligo normativo: \u00e8 necessario accettare l'obbligo di mantenimento dell'impianto per 5 anni prima di archiviare la pratica.");
                return;
            }
        ...
        const defaultCodice = codicePratica || currentNome || "Pratica_" + saDenominazione.replace(/\s+/g, "_");
        ...
        if (codiceExists) {
            const sovrascrivi = confirm("Codice \"" + codiceConfermato + "\" gi\u00e0 esistente.\nOK = Sovrascrivi\nAnnulla = Annulla");
            if (!sovrascrivi) {
                return;
            }
        }
        ...
        try {
            ...
            const dataCrea = _praticaData.pratica.data_creazione || new Date().toISOString();
            ...
            if (Array.isArray(datiToStore.interventi) && datiToStore.interventi.length > 0 && typeof datiToStore.interventi[0] === "string") {
                ...
                datiToStore.interventi = datiToStore.interventi.map(function(code) {
                    const ecoForCode = preventivoSaved.filter(function(p) { return p.codice_intervento === code; });
                    return {
                        id_intervento: id + "_" + code,
                        codice_intervento: code,
                        is_trainante: false,
                        dati_tecnici: (datiToStore.dati_tecnici && datiToStore.dati_tecnici[code]) || {},
                        economico: {
                            spese: speseSaved[code] || 0,
                            preventivo: ecoForCode,
                            totale_spese: ecoForCode.reduce(function(sum, p) { return sum + (parseFloat(p.importo) || 0); }, 0),
    ...
    const _showReportPreview = async function() {
        ...
        const rel = ReliabilityEngine.calculateReliability(_praticaData.dati_tecnici, {});
        ...
        if (p.modalita_accesso === "diretto" && p.data_fine_lavori) {
            ...
            if (!isNaN(dtFine.getTime())) {
                ...
                var ggTrascorsi = Math.floor((oggiDate - dtFine) / (1000 * 60 * 60 * 24));
                ...
                scad5 = new Date(dtFine.getTime() + 5 * 365 * 24 * 60 * 60 * 1000).toISOString().slice(0, 10);
            }
        }
        ...
        const getLabel = function(code, key) {
            ...
            const campo = scheda.campi.find(function(c) { return c.id === key; });
        ...
        interventi.forEach(function(code) {
            const tech = dt[code] || {};
            const meta = INTERVENTI[code] || {};
            const calc = FormulaEngine.calculate(code, tech, { zonaClimatica: ed.zona_climatica, soggetto: sa.tipo_soggetto, codiciSelezionati: interventi, comuneSotto15k: !!ed.comune_sotto_15k, scuolaOspedale: !!ed.scuola_ospedale });
            results[code] = calc;
            const scheda = SCHEDE_TECNICHE[code];
            const spesaField = scheda ? scheda.campi.find(function(c) { return c.categoria === "economico"; }) : null;
            const spesa = spesaField ? parseFloat(tech[spesaField.id]) || 0 : (eco.spese ? eco.spese[code] || 0 : 0);
            ...
            summaryRows = summaryRows + '<tr><td><strong>' + code + '</strong></td>'
                + '<td style="text-align:right;">' + spesaFormatted + '</td>'
                + '<td style="text-align:right;font-weight:700;">' + incentivoFormatted + '</td>'
                + '<td>' + nomeIntervento + '</td></tr>';
        });

        let overallPlanHtml = "";
        const overallPlan = _calculateOverallPaymentPlan(results, sa.tipo_soggetto);
        if (overallPlan) {
            overallPlanHtml = '<div style="margin-top:20px;padding:15px;border:1px solid rgba(104,200,178,0.3);border-radius:6px;background:rgba(104,200,178,0.05);">'
                + '<div style="font-weight:700;color:#68c8b2;font-size:1.1em;margin-bottom:10px;">PIANO DI EROGAZIONE INCENTIVO COMPLESSIVO</div>';
            if (overallPlan.isSinglePayment) {
                overallPlanHtml += '<p style="margin:4px 0;">Erogazione in <strong>unica annualità (soluzione unica)</strong> per importo complessivo sotto la soglia di 15.000 €.</p>'
                    + '<p style="margin:4px 0;font-size:1.1em;">Importo erogato: <strong>' + PreventivoManager.formatCurrency(overallPlan.total) + '</strong></p>';
            } else {
                overallPlanHtml += '<p style="margin:4px 0;">Erogazione suddivisa in <strong>' + overallPlan.numInstallments + ' rate annuali</strong>:</p>'
                    + '<table class="simple-data-table" style="margin-top:8px;font-size:0.95em;width:auto;min-width:300px;">';
                overallPlan.installments.forEach(function(inst) {
                    overallPlanHtml += '<tr><td style="padding:4px 15px 4px 0;"><strong>' + inst.label + '</strong></td>'
                        + '<td style="text-align:right;font-weight:700;">' + PreventivoManager.formatCurrency(inst.amount) + '</td></tr>';
                });
        ...
        interventi.forEach(function(code) {
            ...
            let techRows = "";
            for (const k in tech) {
                if (tech.hasOwnProperty(k) && tech[k] !== "" && tech[k] !== null && tech[k] !== undefined) {
                    const isCosto = k.indexOf("costo_") === 0 || k.indexOf("spesa_") === 0;
                    if (isCosto) {
                        continue;
                    }
                    const label = getLabel(code, k);
                    const rawVal = tech[k];
                    const valStr = typeof rawVal === "number" ? formatNum(rawVal) : rawVal;
                    techRows = techRows + '<tr><td class="field-label">' + label + '</td><td>' + valStr + '</td></tr>';
                }
            }

            const lavorazioni = (info.lavorazioni_comprese || []).map(function(l) { return '<li>' + l + '</li>'; }).join('');
            const calcStatus = calc.status || "OK";
            const nomeInfo = info.nome || "";

            interventiHtml = interventiHtml + '<div class="report-item" style="border-left:5px solid #68c8b2;">'
                + '<div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:15px;">'
                + '<div><h3 style="margin:0;color:#68c8b2;">Intervento ' + code + '</h3>'
                + '<div style="font-weight:600;font-size:1.1em;">' + nomeInfo + '</div></div>'
                + '<div class="tag success" style="font-size:0.8em;">' + calcStatus + '</div></div>'
                + '<div class="report-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:30px;">'
                + '<section><h4>Parametri Tecnici</h4><table class="simple-data-table">' + techRows + '</table></section>'
                + '<section><h4>Lavorazioni Ammesse</h4><ul class="clean-list">' + lavorazioni + '</ul></section></div></div>';
        });

        let watermarkHtml = "";
        if (rel.watermark) {
            watermarkHtml = '<div class="watermark-overlay" style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%) rotate(-45deg);font-size:80px;opacity:0.05;pointer-events:none;white-space:nowrap;color:#d32f2f;font-weight:900;z-index:10;">' + rel.watermark + '</div>';
        }

        const saDenominazione = sa.denominazione || "Report";
        const praticaId = _praticaData.pratica.id || "N/D";
        const totalInvestmentFormatted = PreventivoManager.formatCurrency(totalInvestment);
        ...
        const impianto = ed.impianto_esistente || {};
        const impiantoHtml = '<strong>Impianto Esistente:</strong><br><span style="font-size:0.9em;">'
            ...
            + (impianto.libretto_codice ? " (Cod. " + impianto.libretto_codice + ")" : "")
            + '</span><br>';
        ...
        let html = '<div class="window-header">'
            ...
            + '<button class="close-btn btn-close-win" title="Chiudi">&times;</button>'
            + '</div>'
            + '<div class="window-body" style="position:relative;">' + watermarkHtml
            ...
            + '<div style="margin-top:15px;font-size:0.9em;color:' + darkFg + ';">Data: ' + dateStr + ' | ID: ' + praticaId + '</div>'
            + '</header>'
            ...
            + summaryRows + '</tbody>'
            + '<tfoot><tr style="background:' + bgColor + ';font-size:1.1em;">'
            + '<td><strong>TOTALE</strong></td><td style="text-align:right;font-weight:700;">' + totalInvestmentFormatted + '</td>'
            + '<td style="text-align:right;font-weight:800;color:' + incentiveColor + ';font-size:1.2em;">' + totalIncentiveFormatted + '</td><td></td></tr></tfoot></table>'
            + overallPlanHtml
            + '<div style="margin-top:10px;font-size:0.85em;font-style:italic;color:' + darkFg + ';">Affidabilità: ' + affLabel + '</div></div>'
            ...
            + '<strong>SA:</strong><br><span style="font-size:0.9em;">' + (sa.denominazione || "N/D") + ' (' + (sa.tipo_soggetto || "N/D") + ')</span><br>'
            + '<strong>SR:</strong><br><span style="font-size:0.9em;">' + (sr.denominazione || "N/D") + '</span><br>'
            + '<strong>Proprietario:</strong><br><span style="font-size:0.9em;">' + (prop.denominazione || "N/D") + '</span>'
            + (del.denominazione ? '<br><strong>Delegato:</strong><br><span style="font-size:0.9em;">' + del.denominazione + '</span>' : '')
            + '</td><td style="vertical-align:top;padding:12px;">'
            + '<strong>Indirizzo:</strong><br><span style="font-size:0.9em;">' + (ed.indirizzo || "N/D") + '</span><br>'
            + '<strong>Catasto:</strong><br><span style="font-size:0.9em;">' + (ed.categoria_catastale || "N/D") + ' | Zona ' + (ed.zona_climatica || "N/D") + '</span><br>'
            + '<strong>Superficie:</strong><br><span style="font-size:0.9em;">' + (ed.superficie_utile_mq || "N/D") + ' mq</span><br>'
            + impiantoHtml
            ...
            + '<tr><td>Fine lavori</td><td>' + (p.data_fine_lavori || "N/D") + '</td></tr>'
            + '<tr><td>Richiesta</td><td>' + (p.data_richiesta || "N/D") + '</td></tr>'
            + '<tr><td>Termine 60gg</td><td style="color:' + scadColore + ';font-weight:600;">' + scadMsg + '</td></tr>'
            + '<tr><td>Obbligo 5 anni</td><td>Scadenza ' + scad5 + '</td></tr>'
            + '</tbody></table></div>'
            + '<div class="report-section" style="margin-top:40px;"><h2 style="border-bottom:1px solid #68c8b2;padding-bottom:8px;">4. Dettaglio Interventi</h2>' + interventiHtml + '</div>'
        ...
        try {
            ...
            if (soggetto && report[soggetto]) {
                ...
                budgetHtml = '<div class="report-section" style="margin-top:30px;padding:12px 16px;border:1px solid ' + color + ';border-radius:6px;">'
                    + '<h3 style="margin:0 0 8px;color:' + color + ';">Plafond ' + soggetto + '</h3>'
                    + '<div style="font-size:0.85em;">Budget: ' + r.budget.toLocaleString("it-IT") + ' €</div>'
                    + '<div style="font-size:0.85em;">Utilizzato: ' + r.used.toLocaleString("it-IT", { minimumFractionDigits: 2 }) + ' €</div>'
                    + '<div style="font-size:0.85em;">Residuo: ' + r.residuo.toLocaleString("it-IT", { minimumFractionDigits: 2 }) + ' €</div>'
                    + '<div style="margin-top:6px;height:6px;background:#333;border-radius:3px;overflow:hidden;">'
                    + '<div style="height:100%;width:' + Math.min(pct, 100) + '%;background:' + color + ';border-radius:3px;"></div></div>'
                    + '<div style="font-size:0.75em;margin-top:4px;color:' + color + ';">' + pct + '% utilizzato</div></div>';
            }
        } catch (e) {
            console.error("_showReportPreview: errore plafond", e);
        }
        if (budgetHtml) {
            html = html.replace('</footer></div>', '</footer>' + budgetHtml + '</div>');
        }
        ...
        if (printBtn) {
            printBtn.onclick = function() { _printSintesi(); };
        }
    };
    ...
    const _showCalculationDetails = function() {
        ...
        interventi.forEach(function(code) {
            ...
            if (calc.steps && calc.steps.length > 0) {
                stepsHtml = '<table class="data-table"><thead><tr>'
                ...
                calc.steps.forEach(function(s) {
                    ...
                    const desc = s.desc || "";
                    const label = s.label || "";
                    const calcVal = s.calc || (typeof s.value === "number" ? formatNum(s.value) : s.value);

                    stepsHtml = stepsHtml + '<tr><td>' + desc + '</td>'
                        + '<td><strong>' + label + '</strong></td>'
                        + '<td>' + calcVal + '</td>'
                        + '<td style="text-align:right;font-weight:600;">' + valStr + '</td></tr>';
                });
            ...
            contentHtml = contentHtml
                + '<div style="margin-bottom:32px;"><h3>Intervento ' + code + '</h3>'
                + stepsHtml + '</div>';
        });
    ...
    const _showDocumentiPreview = function() {
        ...
        const dt = _praticaData.dati_tecnici || {};
        const praticaId = _praticaData.pratica.id || "N/D";
        const saDenominazione = (_praticaData.richiedente || {}).denominazione || "Documenti";
        const darkFg = "rgba(255,255,255,0.6)";
        ...
        interventi.forEach(function(code) {
            ...
            docs.forEach(function(doc) {
                ...
                rows = rows + '<tr>'
                    + '<td style="padding:8px 12px;border-bottom:1px solid rgba(255,255,255,0.08);">' + doc + '</td>'
                    + '<td style="padding:8px 12px;border-bottom:1px solid rgba(255,255,255,0.08);text-align:center;">'
                    + '<input type="checkbox" class="doc-checkbox" data-code="' + code + '" data-doc="' + docKey + '" ' + (presente ? "checked" : "") + ' style="width:18px;height:18px;cursor:pointer;">'
                    + '</td>'
                    + '</tr>';
            });

            contentHtml = contentHtml + '<div class="report-item" style="border-left:5px solid ' + color + ';margin-bottom:20px;">'
                + '<div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:12px;">'
                + '<div><h3 style="margin:0;color:' + color + ';">' + code + '</h3>'
                + '<div style="font-weight:600;font-size:1em;">' + nomeIntervento + '</div></div>'
                + '<div class="tag" style="background:' + color + '20;color:' + color + ';font-size:0.8em;border:1px solid ' + color + '40;">'
                + (hasData ? "Dati inseriti" : "Dati mancanti") + '</div></div>'
        ...
        var apeAnteDisponibile = _praticaData.edificio?.ape?.classe_ante ? true : false;
        var apePostDisponibile = apeAnteDisponibile;
        var docApeHtml = '<div class="report-item" style="border-left:5px solid #9c27b0;margin-bottom:20px;">'
            ...
            + '<th style="padding:8px 12px;text-align:center;width:100px;">Presente</th></tr></thead><tbody>'
            + '<tr><td style="padding:8px 12px;">APE ante-operam (classe ' + (_praticaData.edificio?.ape?.classe_ante || "N/D") + ')</td>'
            + '<td style="text-align:center;"><input type="checkbox" class="doc-checkbox" data-code="_APE" data-doc="ape_ante" ' + (apeAnteDisponibile ? "checked" : "") + ' style="width:18px;height:18px;cursor:pointer;"></td></tr>'
            + '<tr><td style="padding:8px 12px;">APE post-operam</td>'
            + '<td style="text-align:center;"><input type="checkbox" class="doc-checkbox" data-code="_APE" data-doc="ape_post" ' + (apePostDisponibile ? "checked" : "") + ' style="width:18px;height:18px;cursor:pointer;"></td></tr>'
        ...
        var docAmminHtml = '<div class="report-item" style="border-left:5px solid #ff9800;margin-bottom:20px;">'
        ...
        for (const key in DOC_AGGIUNTIVI_MAP) {
            if (richiedente.hasOwnProperty(key)) {
                ...
                extraRows = extraRows + '<tr>'
                    + '<td style="padding:6px 12px;border-bottom:1px solid rgba(255,255,255,0.08);">' + label + '</td>'
                    + '<td style="padding:6px 12px;border-bottom:1px solid rgba(255,255,255,0.08);text-align:center;">'
                    + '<span style="display:inline-block;padding:2px 10px;border-radius:10px;font-size:0.8em;font-weight:600;background:' + statusColor + '20;color:' + statusColor + ';">'
                    + icon + ' ' + statusLabel + '</span></td>'
                    + '</tr>';
            }
        }
        if (extraRows) {
            contentHtml = contentHtml + '<div class="report-item" style="border-left:5px solid #1976d2;margin-bottom:20px;">'
                + '<div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:12px;">'
                ...
                + extraRows + '</tbody></table></div>';
        }

        if (!contentHtml) {
            contentHtml = '<p style="text-align:center;padding:40px;opacity:0.6;">Nessun documento richiesto per gli interventi selezionati.</p>';
        }

        const html = '<div class="window-header">'
            + '<span class="title">Documenti Richiesti - ' + saDenominazione + '</span>'
            + '<div class="header-actions">'
            ...
            + '<div style="text-transform:uppercase;letter-spacing:2px;font-weight:600;margin-top:5px;">Conto Termico 3.0</div>'
            + '<div style="margin-top:15px;font-size:0.9em;color:' + darkFg + ';">Pratica: ' + praticaId + '</div>'
            + '<div style="margin-top:8px;font-size:0.9em;color:' + darkFg + ';">Seleziona i documenti disponibili e premi "Salva Documenti"</div>'
            + '</header>'
            + '<div class="report-section">' + contentHtml + '</div>'
        ...
        if (printBtn) {
            printBtn.onclick = function() { _printDocumenti(); };
        }
        ...
        if (saveBtn) {
            saveBtn.onclick = function() {
                ...
                setTimeout(function() { saveBtn.textContent = "Salva Documenti"; }, 2000);
            };
        }
    };
    ...
    const _printDocumenti = function() {
        ...
        const docHtml = '<!DOCTYPE html><html><head><title>Documenti Richiesti CT 3.0</title>'
            + '<style>'
            + 'body{font-family:sans-serif;padding:40px;color:#333;}'
            + 'h1,h2,h3,h4{color:#68c8b2;}'
            + '.report-section{margin-bottom:25px;}'
    ...
    var _substituteParams = function(expr, params) {
        var keys = Object.keys(params).sort(function(a, b) { return b.length - a.length; });
        var result = expr;
    ...
    const _showFormuleIncentivo = function() {
        ...
        interventi.forEach(function(code) {
            ...
            if (tipoFormula === "validato_tecnico") {
                statusBadge = '<span class="tag success" style="font-size:0.75em;">Validato</span>';
            } else if (tipoFormula === "da_validare") {
                statusBadge = '<span class="tag" style="font-size:0.75em;background:#ff980020;color:#ff9800;border:1px solid #ff980040;">Da validare</span>';
            }

            var cardHtml = '<div class="report-item" style="margin-bottom:24px;border-left:5px solid #68c8b2;">'
                + '<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">'
                + '<h3 style="margin:0;color:#68c8b2;">' + code + ' \u2014 ' + nomeIntervento + '</h3>'
                + statusBadge
                + '</div>';

            if (formulaBase) {
                cardHtml += '<div style="margin-bottom:12px;padding:10px 14px;background:rgba(104,200,178,0.08);border-radius:4px;font-family:monospace;font-size:1.05em;">'
                    + '<strong>Formula:</strong> I = ' + formulaBase + '</div>';
            }

            if (calc.steps && calc.steps.length > 0) {
                cardHtml += '<table class="data-table" style="font-size:0.9em;"><thead><tr>'
                ...
                calc.steps.forEach(function(s) {
                    ...
                    cardHtml += '<tr>'
                        + '<td><strong>' + cellDesc + '</strong></td>'
                        + '<td style="font-family:monospace;font-size:0.95em;">' + formulaExpr + '</td>'
                        + '<td style="font-family:monospace;font-size:0.9em;">' + calcVal + '</td>'
            ...
            if (calc.amount !== undefined && calc.amount > 0) {
                ...
                cardHtml += '<div style="margin-top:12px;padding:10px 14px;background:rgba(104,200,178,0.12);border-radius:4px;text-align:center;font-size:1.1em;font-weight:700;">'
                    + 'Risultato: I = ' + (formulaBase || '?') + ' = ' + formattedAmount;
                ...
                if (calc.incentivoNetto !== undefined) {
                    ...
                    cardHtml += '<div style="font-size:0.8em;font-weight:400;margin-top:4px;opacity:0.8;">'
                        + 'Netto GSE: ' + nettoFormatted + ' (corrispettivo GSE: ' + gseFormatted + ')</div>';
                }

                if (calc.paymentPlan) {
                    var rate = calc.paymentPlan.numInstallments;
                    var rataLabel = rate === 1 ? "Unica soluzione" : rate + " rate annuali";
                    cardHtml += '<div style="font-size:0.8em;font-weight:400;opacity:0.7;">Erogazione: ' + rataLabel + '</div>';
                }
            ...
            if (calc.errors && calc.errors.length > 0) {
                var errorHtml = calc.errors.map(function(e) {
                    return '<li>' + e + '</li>';
                }).join("");
                cardHtml += '<div style="margin-top:8px;padding:8px 12px;background:rgba(220,53,69,0.1);border-radius:4px;color:#dc3545;font-size:0.85em;">'
                    + '<strong>Errori:</strong><ul style="margin:4px 0 0 0;">' + errorHtml + '</ul></div>';
            }
        ...
        if (!contentHtml) {
            contentHtml = '<p style="text-align:center;padding:40px;opacity:0.6;">Nessun intervento selezionato.</p>';
        }
    ...
    const _renderStep6 = function() {
        ...
        if (p.modalita_accesso === "diretto" && p.data_fine_lavori) {
            ...
            if (!isNaN(dtFine.getTime())) {
                ...
                var scadMsg = "Nei termini (" + ggResidui + "gg residui su " + termineMax + "gg)";
                if (ggTrascorsi > termineMax) {
                    scadColore = "#f44336";
                    scadMsg = "SCADUTO da " + (ggTrascorsi - termineMax) + " giorni! Richiesta oltre " + termineMax + "gg da fine lavori.";
                } else if (ggResidui <= 15) {
                    scadColore = "#ff9800";
                    scadMsg = "In scadenza! " + ggResidui + "gg residui su " + termineMax + "gg. Affrettarsi.";
                }
                scadenzaHtml = '<div class="card-title" style="margin-top:10px;">SCADENZE</div>'
                    + '<table class="simple-data-table">'
                    + '<tr><td class="field-label">Data fine lavori</td><td>' + (p.data_fine_lavori || "N/D") + '</td></tr>'
                    + '<tr><td class="field-label">Data richiesta</td><td>' + (p.data_richiesta || "N/D") + '</td></tr>'
                    + '<tr><td class="field-label">Termine richiesta</td><td style="color:' + scadColore + ';font-weight:600;">' + scadMsg + '</td></tr>'
                    + '<tr><td class="field-label">Obbligo 5 anni</td><td>Scadenza ' + new Date(dtFine.getTime() + 5 * 365 * 24 * 60 * 60 * 1000).toISOString().slice(0, 10) + ' (5 anni da fine lavori)</td></tr>'
                    + '</table>';
            }
        }

        const intestazioneHtml = '<div class="card-title">DATI GENERALI</div>'
            + '<table class="simple-data-table">'
            + '<tr><td class="field-label">Codice</td><td>' + pCodice + '</td></tr>'
            + '<tr><td class="field-label">Nome</td><td>' + pNome + '</td></tr>'
            + '<tr><td class="field-label">Data richiesta</td><td>' + (p.data_richiesta || "N/D") + '</td></tr>'
            + '<tr><td class="field-label">Data fine lavori</td><td>' + (p.data_fine_lavori || "N/D") + '</td></tr>'
            + '<tr><td class="field-label">Modalit\u00e0 accesso</td><td>' + pAccesso + '</td></tr>'
            + '<tr><td class="field-label">ID</td><td>' + pId + '</td></tr>'
            + '</table>';

        const edificioHtml = '<div class="card-title" style="margin-top:20px;">EDIFICIO</div>'
            + '<table class="simple-data-table">'
            + '<tr><td class="field-label">Indirizzo</td><td>' + edIndirizzo + '</td></tr>'
            + '<tr><td class="field-label">Catasto</td><td>' + edCatasto + '</td></tr>'
            + '<tr><td class="field-label">Zona</td><td>' + edZona + '</td></tr>'
            + '<tr><td class="field-label">Superficie</td><td>' + edSuperficie + ' mq</td></tr>'
            + '<tr><td class="field-label">Anno costruzione</td><td>' + edAnno + '</td></tr>'
            + '</table>';

        let delegatoRow = "";
        if (delDenom) {
            delegatoRow = '<tr><td class="field-label">Delegato</td><td>' + delDenom + '</td></tr>';
        }

        const soggettiHtml = '<div class="card-title" style="margin-top:20px;">SOGGETTI</div>'
            + '<table class="simple-data-table">'
            + '<tr><td class="field-label">SA</td><td>' + rDenom + ' (' + rTipo + ')</td></tr>'
            + '<tr><td class="field-label">SR</td><td>' + sDenom + '</td></tr>'
            + '<tr><td class="field-label">Proprietario</td><td>' + propDenom + '</td></tr>'
            + delegatoRow
            + '</table>';

        let interventiHtml = '<div class="card-title" style="margin-top:20px;">INTERVENTI (' + interventi.length + ')</div>'
            + '<div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:10px;">';

        interventi.forEach(function(code) {
            const meta = INTERVENTI[code] || {};
            const nomeMeta = meta.nome || "";
            interventiHtml = interventiHtml
                ...
                + '<strong>' + code + '</strong> ' + nomeMeta + '</span>';
        });
        interventiHtml = interventiHtml + '</div>';

        let ecoHtml = '<div class="card-title" style="margin-top:20px;">ECONOMICO</div>'
            + '<table class="simple-data-table">';
        if (eco.spese) {
            for (const code in eco.spese) {
                if (eco.spese.hasOwnProperty(code)) {
                    const val = eco.spese[code] || 0;
                    ecoHtml = ecoHtml + '<tr><td class="field-label">' + code + '</td><td>' + PreventivoManager.formatCurrency(val) + '</td></tr>';
                }
            }
        }
        ...
        if (interventi.length > 0) {
            ...
            obbligoMantenimentoHtml = '<div class="card-title" style="margin-top:20px;">OBBLIGHI NORMATIVI</div>'
                ...
                + '<input type="checkbox" id="chk-obbligo-mantenimento" ' + (accettato ? "checked" : "") + ' style="margin-top:3px;">'
        ...
        section.innerHTML = step6Title + btnGroup + intestazioneHtml + scadenzaHtml + edificioHtml + soggettiHtml + interventiHtml + ecoHtml + obbligoMantenimentoHtml;
        return section;
    };
    ...
    const _connectStep6Actions = function() {
        ...
        if (documentiBtn) documentiBtn.addEventListener("click", _showDocumentiPreview);
    ...
    const _showContextHelp = function(step) {
        ...
        if (step === 0) {
            content = "<p>In questa pagina si inseriscono i dati generali della pratica.</p>"
                + "<h2>Campi</h2>"
                + "<ul>"
            ...
            content = "<p>Inserisci le caratteristiche catastali e climatiche dell'edificio.</p>"
                + "<h2>Campi</h2>"
                + "<ul>"
            ...
            content = "<p>Inserisci i tre soggetti obbligatori e il delegato opzionale.</p>"
                + "<h2>Soggetti</h2>"
                + "<ul>"
            ...
            content = "<p>Scegli gli interventi ammessi in base al tipo di SA e all'ambito dell'edificio.</p>"
            ...
            content = "<p>Per ogni intervento selezionato, inserisci i parametri tecnici richiesti.</p>"
                + "<h2>Campi</h2>"
                + "<ul>"
            ...
            content = "<p>Inserisci l'importo della spesa per ogni intervento e calcola l'incentivo.</p>"
                + "<h2>Campi</h2>"
                + "<ul>"
            ...
            content = "<p>Riepilogo finale di tutti i dati inseriti nella pratica.</p>"
                + "<h2>Pulsanti</h2>"
                + "<ul>"
                + "<li><strong>REPORT</strong> — apre una finestra con il report dettagliato della pratica.</li>"
        ...
        var fgStyle = isDark ? "color:rgba(255,255,255,0.8)" : "color:rgba(0,0,0,0.8)";

        var headerTitle = STEP_HELP_TITLES[step] || "Help";
        var html = '<div class="window-header">'
            + '<span class="title" style="font-size:1.4em;color:#68c8b2;font-weight:700;">' + headerTitle + '</span>'
            + '<div class="header-actions"></div>'
            + '<button class="close-btn btn-close-help" title="Chiudi">&times;</button>'
            + '</div>'
            + '<div class="window-body" style="overflow-y:auto;padding:20px 40px 60px;' + fgStyle + '">'
            + content
            + '</div>';
    ...
    const _renderStep = function(step) {
        ...
        var content = null;
        switch (step) {
            case 0: content = _renderStep0(); break;
            case 1: content = _renderStep1(); break;
            case 2: content = _renderStep2(); break;
            case 3: content = _renderStep3(); break;
            case 4: content = _renderStep4(); break;
            case 5: content = _renderStep5(); break;
            case 6: content = _renderStep6(); break;
        }
        if (content) {
    ...
    const _validateStep0 = function() {
        ...
        _bindFormData(section, _praticaData.pratica);
        if (!_praticaData.pratica.nome || _praticaData.pratica.nome.trim() === "") { alert("Inserire il nome."); return false; }
        if (!_praticaData.pratica.modalita_accesso) { alert("Selezionare modalit\u00e0 accesso."); return false; }
        if (_praticaData.pratica.modalita_accesso === "diretto") {
            const df = _praticaData.pratica.data_fine_lavori;
            if (!df) { alert("Per accesso diretto \u00e8 richiesta la data fine lavori."); return false; }
            const dtFine = new Date(df);
            if (isNaN(dtFine.getTime())) { alert("Data fine lavori non valida."); return false; }
            if (dtFine > new Date()) { alert("Per accesso diretto la data fine lavori deve essere gi\u00e0 passata (intervento concluso)."); return false; }
            ...
            if (dr) {
                ...
                if (!isNaN(dtRich.getTime())) {
                    ...
                    if (diff > 60) { alert("La richiesta supera i 60 giorni dalla fine lavori. Termine massimo accesso diretto: 60 giorni."); return false; }
                    if (diff < 0) { alert("La data richiesta non pu\u00f2 essere prima della fine lavori."); return false; }
                }
            }
        }
        if (_praticaData.pratica.modalita_accesso === "prenotazione") {
            const dr = _praticaData.pratica.data_richiesta;
            if (!dr) { alert("Per accesso in prenotazione \u00e8 richiesta la data richiesta."); return false; }
        }
        return true;
    };
    ...
    const _validateStep1 = function() {
        ...
        if (!section) return false;
        _bindFormData(section, _praticaData.edificio);
        if (!_praticaData.edificio.indirizzo || !_praticaData.edificio.categoria_catastale || !_praticaData.edificio.zona_climatica) { alert("Compilare tutti i campi obbligatori edilizi."); return false; }
        return true;
    };
    ...
    const _validateStep2 = function() {
        ...
        if (!section) return false;
        _bindFormData(section, _praticaData);
        _praticaData.delegato = { denominazione: (_praticaData.delegato && _praticaData.delegato.denominazione) || "", cf: (_praticaData.delegato && _praticaData.delegato.cf) || "", qualifica: (_praticaData.delegato && _praticaData.delegato.qualifica) || "", email: (_praticaData.delegato && _praticaData.delegato.email) || "" };
        const p = _praticaData.proprietario, r = _praticaData.richiedente, rs = _praticaData.responsabile;
        if (!p.denominazione || !r.denominazione || !rs.denominazione) { alert("Compilare tutte e tre le anagrafiche."); return false; }
        if (!r.tipo_soggetto || !rs.tipo_soggetto) { alert("Selezionare tipo soggetto per SA e SR."); return false; }
        return true;
    };
    ...
    const _validateStep3 = function() {
        ...
        if (!section) return false;
        const checkboxes = section.querySelectorAll("input[name=intervento]:checked");
        const selected = [];
        checkboxes.forEach(function(cb) { selected.push(cb.value); });
        _praticaData.interventi = selected;
        if (selected.length === 0) { alert("Selezionare almeno un intervento."); return false; }
        const tipoSA = _praticaData.richiedente.tipo_soggetto || "";
        const ambito = _praticaData.edificio.ambito || "";
        const result = _rulesEngine.validateInterventiPerSoggetto(tipoSA, ambito, selected);
        if (!result.success) { alert("Errore:\n" + result.errors.join("\n")); return false; }
        return true;
    };
    ...
    const _updateGlobalNav = function() {
        var btns = ["btn-wiz-start-global", "btn-wiz-prev-global", "btn-wiz-next-global", "btn-wiz-end-global"];
    ...
    var _generateTmpId = function() {
        var id = "TMP_" + Date.now() + "_" + Math.random().toString(36).substr(2, 5);
        return id;
    };
    ...
    var _mergeTestSoggetti = function(scenario) {
        ...
        var ind = sa.indirizzo || sogg.indirizzo || scenario.edificio?.indirizzo || scenario.immobile?.indirizzo || "Via Roma 10, Milano";
        var pecDefault = "test@" + (sa.denominazione || "utente").replace(/[^a-zA-Z]/g, "").toLowerCase() + ".legalmail.it";
            ...
            scheda.campi.forEach(function(campo) {
                ...
                if (campo.tipo === "number") {
                    ...
                    if (campo.opzioni && campo.opzioni.length > 0) {
                        var preferred = (campo.opzioni.indexOf("s\u00ec") !== -1) ? "s\u00ec" : campo.opzioni[0];
    ...
    var _loadTestScenario = async function(scenario) {
        ...
        var apeRaw = scenario.immobile?.classeEnergeticaAnte || scenario.edificio?.classe_ante || "";
        var apeClasse = apeRaw.toUpperCase();

        var rawDati = scenario.valori_campi || scenario.interventiData || {};
        var interventiList = scenario.interventi || scenario.selectedInterventi || [];
        ...
        _praticaData = {
            ...
            edificio: {
                ...
                impianto_esistente: scenario.edificio?.impianto_esistente || {
                    ...
                    potenza_kw: scenario.edificio?.potenza_esistente_kw || scenario.immobile?.potenza_esistente_kw || 0,
                    combustibile: scenario.edificio?.combustibile_ante || scenario.immobile?.combustibile_ante || "",
                    libretto: false,
                    libretto_codice: ""
                },
    ...
    var _connectTestButton = function() {
        ...
        btn.onclick = function() {
            ...
            overlay.style.cssText = "position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.5);z-index:20010;display:flex;align-items:center;justify-content:center;";

            var win = document.createElement("div");
            win.id = winId;
            win.style.cssText = "background:#252525;border:1px solid #68c8b2;border-radius:8px;min-width:620px;max-width:95%;box-shadow:0 11px 15px -7px rgba(0,0,0,0.5);z-index:20011;";

            var headerHtml = '<div style="background:#1e1e1e;color:#e0e0e0;padding:10px 15px;display:flex;justify-content:space-between;align-items:center;cursor:move;border-radius:8px 8px 0 0;border-bottom:1px solid rgba(104,200,178,0.3);">'
            ...
            var bodyHtml = '<div style="padding:16px 20px 20px;"><p style="margin-bottom:12px;font-size:0.9rem;color:rgba(224,224,224,0.7);">Seleziona uno scenario predefinito per caricare automaticamente tutti i dati:</p>'
            ...
            TEST_SCENARIOS_LIST.forEach(function(s) {
                if (s.group) {
                    bodyHtml += '<div style="font-weight:bold;color:#68c8b2;padding:8px 4px 2px 4px;font-size:0.8rem;letter-spacing:0.5px;text-transform:uppercase;border-bottom:1px solid rgba(104,200,178,0.15);">'
                        + s.group + '</div>';
                } else {
                    bodyHtml += '<button class="scenario-btn" data-file="' + s.file + '"'
            ...
            win.querySelectorAll(".scenario-btn").forEach(function(btn) {
                btn.onclick = async function(e) {
                    var fetchPath = e.currentTarget.getAttribute("data-file") + "?t=" + Date.now();
                    try {
    ...
    const api = {
        ...
        init: async function() {
            ...
            if (!_praticaData.pratica.data_inserimento) {
                _praticaData.pratica.data_inserimento = new Date().toISOString().slice(0, 10);
            }
            _currentStep = 0;
            _renderStep(0);
            _updateGlobalNav();
        ...
        goToEnd: _goToEnd,
        getData: function() { return _praticaData; },
        loadData: function(data) {
            if (!data) return;
            _normalizeFromComposed(data);
            if (Array.isArray(data.interventi) && data.interventi.length > 0 && typeof data.interventi[0] === "object") {
                data.interventi = data.interventi.map(function(iv) {
                    return iv.codice_intervento || "";
                }).filter(function(code) { return code !== ""; });
            }
        ...
        showReport: function(dati) {
            ...
            if (Array.isArray(cloned.interventi) && cloned.interventi.length > 0 && typeof cloned.interventi[0] === "object") {
                cloned.interventi = cloned.interventi.map(function(iv) {
                    return iv.codice_intervento || "";
                }).filter(function(code) { return code !== ""; });
            }
        ...
        reset: function() {
            _praticaData = { pratica: { id: "", codice: "", data_inserimento: "", data_richiesta: "", data_fine_lavori: "", nome: "", modalita_accesso: "diretto", note: "" }, proprietario: {}, richiedente: {}, responsabile: {}, delegato: {}, edificio: { indirizzo: "", categoria_catastale: "", ambito: "", zona_climatica: "", anno_costruzione: null, superficie_utile_mq: null, impianto_esistente: { tipo: "", potenza_kw: 0, combustibile: "", libretto: false, libretto_codice: "" }, ape: {} }, interventi: [], dati_tecnici: {}, economico: { preventivo: [], maggiorazioni: [], incentivo: null }, documenti: {} };
            _currentStep = 0;
            _renderStep(0);
            _updateGlobalNav();
        }
